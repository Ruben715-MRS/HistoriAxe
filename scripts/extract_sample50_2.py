...
sample50_2 = {ev['id']: ev['titre'] for p, ev in long_events[50:100]}
with open('scripts/sample50_2.json', 'w', encoding='utf-8') as f:
    json.dump(sample50_2, f, ensure_ascii=False, indent=2)

print("Saved sample50_2.json")
