...
# Let's inspect titles containing verbs vs nominal titles
starts = Counter([ev['titre'].split()[0] for p, ev in long_events])
print("Top 40 starting words:")
for w, c in starts.most_common(40):
    print(f"  {w:15s}: {c}")
